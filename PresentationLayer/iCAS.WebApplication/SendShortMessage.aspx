...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <style type="text/css">
        ...
        #ContentPlaceHolder1_liStudentsSection > ul > li.GridView,
        #ContentPlaceHolder1_liStaffSection > ul > li.GridView {
    ...
    <script type="text/javascript">
        ...
        function ValidateBeforeSendMessage() {
            alert("okay");
            var btn = document.getElementById("<%= btnSendSMS.ClientID %>");
    ...
    <asp:UpdatePanel runat="server" ID="updatePanel_SendSMS" UpdateMode="Always">
        <ContentTemplate>
            ...
            <div class="innercontent" style="min-height: 600px">
                ...
                <ul id="CreateMessaegUL">
                    ...
                    <li class="FormButtons sendButton">
                        ...
                        <asp:Button runat="server" ID="btnSendSMS" Text="SEND MESSAGE" OnClientClick="if (ValidateBeforeSendMessage()==false) {return false;}" OnClick="btnSendSMS_Click" CssClass="btn btn-primary" CausesValidation="true" />
                    </li>
                    <li class="FormButtons chooseButton">
                        ...
                        <asp:CheckBox runat="server" ID="chk_Staffs" Checked="false" OnCheckedChanged="chk_Staffs_CheckedChanged" Text="Staffs"  AutoPostBack="false" />&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <asp:Button runat="server" ID="btnShowRecords" Text="Display Records" OnClick="btnShowRecords_Click" CssClass="btn  btn-success btn-xs ml-2" CausesValidation="false" />
                    </li>

                    <li>
                        <asp:CheckBoxList runat="server" ID="chkList_Classes" RepeatLayout="UnorderedList" Visible="false" CssClass="classListcss">                           
                ...
                <%--DISPLAY RECORDS--%>
                <ul id="DisplayRecordsUL" runat="server" style="display:block">

                    <li id="liStaffSection" runat="server">
                        <ul>
                            <li>                                                               
                            ...
                            <li class="GridView">
                                <span class="PageSubTitle">Staffs:
                                    <asp:Label runat="server" ID="lblStaffCount" Text="(0)" CssClass="CountClass badge badge-primary p-2 m-2" />
                                </span>
                                <asp:GridView ID="grdview_Staffs" runat="server" AutoGenerateColumns="false" CssClass="GridView">
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                                <asp:CheckBox runat="server" ID="chkCheckAllStaffs" OnCheckedChanged="chkCheckAllStaffs_CheckedChanged" AutoPostBack="true" Checked="true" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
                    ...
                    <li id="liStudentsSection" runat="server">
                        <ul>
                            ...
                            <li class="GridView">
                                 <span class="PageSubTitle">Students:
                                    <asp:Label runat="server" ID="lblStudentsCount" Text="(0)" CssClass="StudentCountClass bagde badge-primary p-2" />
                                </span>
                                <asp:GridView ID="grdview_Students" runat="server" AutoGenerateColumns="false" CssClass="GridView">
                                    <Columns>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                                <asp:CheckBox runat="server" ID="chkCheckAllStudents" OnCheckedChanged="chkCheckAllStudents_CheckedChanged" AutoPostBack="true" Checked="true" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
