...
namespace Micro.IntegrationLayer.HumanResource
{
    public partial class EmployeeProfileIntegration
    {
        ...
        public static int UpdateEmployeeProfilePhoto(EmployeeProfile theEmployeeProfile)
        {
            return EmployeeProfileDataAccess.GetInstance.UpdateEmployeeProfilePhoto(theEmployeeProfile);
        }
